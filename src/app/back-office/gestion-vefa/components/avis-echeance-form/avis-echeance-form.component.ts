...
@Component({
  selector: 'app-avis-echeance-form',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './avis-echeance-form.component.html',
  styleUrl: './avis-echeance-form.component.scss',
})
export class AvisEcheanceFormComponent implements OnInit {
  @Input() singleLot!: any;
  @Input() formData: any = {};
